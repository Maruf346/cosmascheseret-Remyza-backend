...
class TaggedAutoSchema(AutoSchema):
    ...
    TAGS_BY_PREFIX = (
        ...
        ("/api/v1/me/business-profile/", "Business Profile"),
        ("/api/v1/me/business-settings/", "Business Settings"),
        ("/api/v1/me/onboarding-status/", "Business Onboarding"),
        ("/api/v1/me/notification-settings/", "Notifications"),
        ("/api/v1/me/", "User Account"),
        ("/api/v1/business/profile/setup/", "Business Onboarding"),
